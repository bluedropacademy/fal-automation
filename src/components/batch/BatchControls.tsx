  ...
  return (
    <div className="flex items-end gap-3">
      <div className="flex-1">
        ...
        <div className="relative">
          ...
          <input
            ...
            disabled={isRunning}
            className="input-base w-full rounded-lg border border-border bg-white pr-9 pl-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary disabled:opacity-50"
          />
        </div>
      </div>
      ...
      {isRunning ? (
        <button
          onClick={handlePause}
          className="flex items-center gap-2 rounded-lg border-2 border-amber-500 px-6 py-2.5 text-sm font-bold text-amber-600 hover:bg-amber-500 hover:text-white transition-all"
        >
        ...
        <>
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-amber-500 px-6 py-2.5 text-sm font-bold text-white hover:bg-amber-600 shadow-md transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-muted px-4 py-2.5 text-sm font-medium text-muted-foreground hover:bg-muted/70 transition-colors"
          >
        ...
        <>
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl bg-primary px-8 py-3 text-base font-bold text-primary-foreground hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/25 transition-all"
          >
            <Play className="h-5 w-5" />
            התחל יצירה
            <kbd className="mr-1 rounded-md bg-white/15 px-1.5 py-0.5 text-[11px] font-mono leading-none">
              Ctrl+Enter
            </kbd>
          </button>
          {isFinished && stuckOrFailedCount > 0 && (
            <button
              onClick={handleResume}
              className="flex items-center gap-2 rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-amber-600 shadow-md transition-all"
            >
